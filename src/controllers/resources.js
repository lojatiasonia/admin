      ...
      $(`#t${tabId}-export-all`).click(function () {
        ...
        switch (slug) {
          ...
          case 'orders':
            ...
            url += '&created_at>=2020-01-01T03:00:00.000Z&created_at<=2022-05-01T02:59:59.000Z&fields=buyers.doc_number,buyers.main_email,items.name,items.quantity,items.sku,amount,created_at'
